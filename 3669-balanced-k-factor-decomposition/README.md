<h2><a href="https://leetcode.com/problems/balanced-k-factor-decomposition/?envType=problem-list-v2&envId=backtracking">3947. Balanced K-Factor Decomposition</a></h2><h3>Medium</h3><hr><p>Given two integers <code>n</code> and <code>k</code>, split the number <code>n</code> into exactly <code>k</code> positive integers such that the <strong>product</strong> of these integers is equal to <code>n</code>.</p>
